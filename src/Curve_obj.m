...
classdef Curve_obj < handle
    ...
    methods
        ...
        function samples = get_mex_samples(obj)
            ...
            % without calling back into MATLAB. See build_curve_samples.m for
            % the sampling details (padded domain, constant-closure
            % broadcasting) -- shared with IE_curve_obj.get_mex_samples so
