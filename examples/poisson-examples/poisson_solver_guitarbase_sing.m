...
n_y     = 2187;
int_eps = 1e-13;
save_path = 'poisson_solver_guitarbase_sing_h4.mat';
...
tic;
rng('default')
[u_num_mat, R] = poisson_solver(curve_seq, f, u_boundary, h, 1, p, int_eps, 1e-13, 1e-13, d, C, n_r, A, Q, M, n_x, n_y, true, corner_r);
toc;

save(save_path, "R", "u_num_mat")